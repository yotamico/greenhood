...
// GreenHOOD Sage Calm design tokens
// paper:#F5F2E8  surface:#FFF  ink:#2D2A24  primary:#6B9956  accent:#C97464  muted:#7A7363
const s: Record<string, React.CSSProperties> = {
  ...
  card: {
    ...
    alignItems: "center",
    gap: 0,
    boxShadow: "6px 6px 0 rgba(45,42,36,0.18)",
  },
  logo:    { fontSize: 52, marginBottom: 8 },
  appName: { fontSize: 26, fontWeight: 900, color: "#2D2A24", margin: 0 },
  appSub:  { fontSize: 13, color: "#7A7363", margin: "6px 0 24px", textAlign: "center" },
  tabs: {
    display: "flex",
    width: "100%",
    background: "#EDE6D2",
  ...
  tabActive: {
    background: "#2D2A24",
    color: "#FFFFFF",
    boxShadow: "1px 1px 0 rgba(45,42,36,0.2)",
  },
  form: {
    width: "100%",
    display: "flex",
  ...
  btn: {
    ...
    cursor: "pointer",
    fontFamily: "'Rubik', 'Heebo', sans-serif",
    boxShadow: "3px 3px 0 rgba(45,42,36,0.22)",
  ...
  googleBtn: {
    ...
    cursor: "pointer",
    fontFamily: "'Rubik', 'Heebo', sans-serif",
    boxShadow: "3px 3px 0 rgba(45,42,36,0.18)",
    transition: "opacity 0.15s",
    marginBottom: 4,
  },
  dividerRow: {
